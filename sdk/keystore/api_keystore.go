...
func New(service *base.APIClient) *KeystoreApiService {
	return &KeystoreApiService{service}
}
...
@return model.ApiSignTxResult
*/
func (a *KeystoreApiService) ApiV1KeystoreSigntxPost(ctx _context.Context, localVarOptionals *KeystoreApiApiV1KeystoreSigntxPostOpts) (model.ApiSignTxResult, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  model.ApiSignTxResult
	)
	...
	if localVarOptionals != nil && localVarOptionals.ApiSignTxParam.IsSet() {
		localVarOptionalApiSignTxParam, localVarOptionalApiSignTxParamok := localVarOptionals.ApiSignTxParam.Value().(model.ApiSignTxParam)
		if !localVarOptionalApiSignTxParamok {
			return localVarReturnValue, nil, base.ReportError("apiSignTxParam should be ApiSignTxParam")
		}
